...
;(function($, doc, win){
    ...
    function newVideo(){
        ...
        return $("<iframe>").prop({ scrolling:'yes', frameborder:0, allowTransparency:true, src:url }).attr({webkitAllowFullScreen:true, mozallowfullscreen:true, allowFullScreen:true});
    }
